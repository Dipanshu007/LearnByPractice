...
public class InitializeAllBeansWithConfigurationAndComponentScanApplication {
    ...
    public static void main (String[] args) {
        ...
        AnnotationConfigApplicationContext applicationContext =
                new AnnotationConfigApplicationContext(InitializeAllBeansWithConfigurationAndComponentScan.class);
